...
**חלק חופשי (בחר 1-2 שרלוונטיים היום):**

תסתכל על הנתונים ותבחר את מה שהכי מעניין היום. אפשרויות:
- 🔥 סרטון ישן שממשיך להדהד (אם הדלתא גבוהה מ-1,000)
- 📈 מגמה או נושא חם שחוזר
- ⚡ הפתעה - סרטון שהצליח/נכשל מעבר לצפוי
- 🎬 תצפית על סוג תוכן שעובד (Shorts vs רגיל, אורך, נושא)
- 👤 קרדיט ליוצר/כתב שבלט

אל תכתוב על כולם - בחר רק מה שבאמת מעניין ורלוונטי היום. אם אין משהו בולט, עדיף לדלג מאשר להמציא.

=== סגנון ===
- קצר ועובדתי, בלי הטפות
- ציין תמיד אם סרטון הוא Shorts
- אל תמציא ואל תנחש
- תן ערך - אל תחזור על מה שברור מהמספרים
"""
